...
int main()
{
	...
	int graph[V][V] =
	{
		 {INT_MAX , 2  ,INT_MAX ,8   ,2   ,INT_MAX ,INT_MAX ,INT_MAX}, //v1
		 {2   ,INT_MAX ,3   ,10  ,5   ,INT_MAX ,INT_MAX ,INT_MAX}, //v2
		 {INT_MAX ,3   ,INT_MAX ,INT_MAX ,12  ,INT_MAX ,INT_MAX ,7},//v3
		 {8   ,10  ,INT_MAX ,INT_MAX ,14  ,3   ,1   ,INT_MAX},//v4
		 {2   ,5   ,12  ,14  ,INT_MAX ,11  ,4   ,8},//v5
		 {INT_MAX ,INT_MAX ,INT_MAX ,3   ,11  ,INT_MAX ,6   ,INT_MAX},//v6
		 {INT_MAX ,INT_MAX ,INT_MAX ,1   ,4   ,6   ,INT_MAX ,9},//v7
		 {INT_MAX ,INT_MAX ,7   ,INT_MAX ,8   ,INT_MAX ,9   ,INT_MAX},//v8
	};
